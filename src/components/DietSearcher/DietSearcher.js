...
export class DietSearcher extends Component {
  ...
  saveRecipe = () => {
    ...
    const newRecipeFullInfo = {
      ...newRecipe,
      savedRecipeInfo: this.state.moreInfoRecipe.moreInfoResult,
    };
    ...
    if (typeof Storage !== 'undefined') {
      localStorage.setItem(
        ...
        JSON.stringify(this.state.savedRecipes)
      );
      localStorage.setItem(
        '@calorie-police/userRecipesTotalCalories',
        JSON.stringify(this.state.userRecipesTotalCalories)
      );
    }
  };
  ...
  render() {
    return (
      <div>
        <h3>
          Search and add the recipe you want to your diet and we will tell you
          if it fits your daily caloric need!
        </h3>
        <DietForm
